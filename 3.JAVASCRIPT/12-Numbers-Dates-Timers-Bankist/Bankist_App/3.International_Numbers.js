...
const displayMovements = function (acc, sort = false) {
	...
	movs.forEach(function (mov, i) {
		...
		// --------------- Add the currency by currentUser ------------------ //
		...
		// 	/// use the account object property
		...
		// /// add the formattedMov variable to the html movement value


		//! AS THE CURRENCY IS IN DIFFERENT PLACES ON THE PAGE - USE A FUNCTION SO DRY IS USED
		...
		//! call the functon using the values from the formattedMov variable above
...
const displayBalance = function (currAcc) {
	...
	/// call the formatCurrency function for the display balance

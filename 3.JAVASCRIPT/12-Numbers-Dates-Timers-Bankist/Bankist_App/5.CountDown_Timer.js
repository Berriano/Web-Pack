...
//! add timer to keep it in parent scope
...
const startLogoutTimer = function () {
	...
	/// create a function inside to be calledback in the setInternal and also to be called
	/// straight away to start the timer immediatley
	...
	const tick = function () {
		...
		/// when reaches 0 , stop timer , logout user and reset welcome
	...
	/// call the tick function to start timer immediatly
	...
	//! return timer so can used as a varible and cleared
...
btnLogin.addEventListener('click', function (e) {
	...
	if (currentAccount?.pin === Number(inputLoginPin.value)) {
		...
		/// if the timer exist(is running from previous login) then clear it
		...
		/// set the timer function to the startLogoutTimer function

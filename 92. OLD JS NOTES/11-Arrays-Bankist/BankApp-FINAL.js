...
//! assign calcDaysPassed function with argument  DATE and MOVEMENT DATE


///? date1 = new Date()   (todays date)


///? date2 = const date = new Date(acc.movementsDates[i]);


///? 	const daysPassed = calcDaysPassedjonas (new Date() , date)


//! new Date(acc.movementsDates[i]) - new Date()
...
// ----------------------- and displaying Movements function --------------------- //

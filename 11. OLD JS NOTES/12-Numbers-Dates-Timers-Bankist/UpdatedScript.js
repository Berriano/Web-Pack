...
const displayDate =`${moVday}/${moVmonth}/${moVyear} `
...
//! convert to ISOString otherwise will be an object
...
/// Adding padding for zero on single digits



//! needs to convert to a string

//! pad the start, making string 2 charachters long, adding a zero when its only 1.
